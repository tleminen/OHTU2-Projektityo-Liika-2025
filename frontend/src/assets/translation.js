...
const translations = {
  EN: {
    ...
    event_join_error:"Error joining event",
    ...
    otp_robot_check: "Making sure you're human",
  ...
  FI: {
    ...
    event_join_error:"Virhe liittyessä tapahtumaan",
    event_join_success:"Liitytty tapahtumaan",
    event_deletion_warning: "Haluatko poistaa tapahtuman esiintymän?",
    event_deletion_failure:"Virhe tapahtuman poistossa",
    event_leave_success: "Poistuttu tapahtumasta",
    event__leave_failure: "Virhe tapahtumasta poistumisessa",
