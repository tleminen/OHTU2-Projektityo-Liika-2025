...
const translations = {
  EN: {
    ...
    can_resend_in: "You can resend in",
    change: "Change",
    ...
    clear: "Clear",
    close: "Close",
    closeFieldCalendars: "Close calendars",
    ...
    email_send_wait: "You have to wait 30 seconds to resend",
    ...
    fields: "Fields",
    fieldsInfoText: "Open fields one by one or open all fields from buttons below",
    filter: "Filter",
    ...
    noFieldsToShow: "No fields to show",
    no_upcoming_events: "No upcoming events",
    open: "Open",
    openFieldCalendars: "Open all calendars",
    ...
    reservationSystemLoadFailed: "Reservation system loading failed",
    save: "Save",
    ...
    setHomeLocation: "Click on the map to change your home location",
    ...
    show_reservation_info: "Show more",
  ...
  FI: {
    ...
    accountInformation: "Omat tietosi",
    activity: "Laji",
    ...
    can_resend_in: "Voit uudelleen lähettää",
    change: "Vaihda",
    changeMapAppearance: "Change the map's appearance",
    ...
    email_send_wait: "Sinun tulee odottaa 30 sekuntia lähettääksesi koodi uudelleen",
    ...
    fields: "Kentät",
    fieldsInfoText: "Voit tarkastella yksittäistä kenttää painamalla sitä tai avata kaikkien kenttien kalenterit nähtäville samaan aikaan",
    filter: "Suodata",
    ...
    noFieldsToShow: "Ei näytettäviä kenttiä",
    no_upcoming_events: "Ei tulevia tapahtumia",
    open: "Avaa",
    openFieldCalendars: "Avaa kenttien kalenterit",
    ...
    reservationSystemLoadFailed: "Kenttävarausjärjestelmän lataus epäonnistui",
    save: "Tallenna",
    ...
    setHomeLocation: "Napauta karttaa asettaaksesi uuden kotisijainnin",
    ...
    showFields: "Näytä kentät",
    showPastEvents: "Menneet tapahtumat",
    showUpcomingEvents: "Tulevat tapahtumat",
    show_reservation_info: "Avaa varauskalenteri",
